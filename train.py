...
from models.r2cnet_v1 import Network
...
def train(train_loader, model, optimizer, epoch, save_path, writer):
    ...
    epoch_step = 0
    try:
        for i, (images, gts, supp_feats, name, c) in enumerate(train_loader, start=1):
            optimizer.zero_grad()
            images = images.cuda()
            gts = gts.cuda()
...
def val(test_loader, model, epoch, save_path, writer):
    ...
    with torch.no_grad():
        with tqdm(total=len(test_loader)) as pbar:
            for (image, gt, sf, name, c) in test_loader:
        ...
        # print('Epoch: {}, MAE: {}, bestMAE: {}, bestEpoch: {}.'.format(epoch, mae1, best_mae, best_epoch))
        str = 'Epoch: {}, MAE: {}, bestMAE: {}, bestEpoch: {}, Sm: {}, adaEm: {}, wF: {}.'.format(epoch, mae1, best_mae, best_epoch, sm1, adpem1, wfm1)
        str += '\n'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='AKF-Net')
    ...
    parser.add_argument('--data_root', type=str, default='R2C7K')
    parser.add_argument('--save_root', type=str, default='clutter_info/ckpt/sam_dino_backbone', help='the path to save model params and log')
